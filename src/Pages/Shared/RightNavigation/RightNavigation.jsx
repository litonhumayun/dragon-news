...
const RightNavigation = () => {
  return (
    <div>
      <div className="mb-4">
        <h2 className="p-2 round m-2">Login With</h2>

        <div className="grid grid-cols-1 gap-2 p-2 round m-2">
          {/* Email */}
      ...
      <div className="mb-4">
        <h2 className="p-2 round m-2">Find Us On</h2>
        ...
        <div className="grid grid-cols-1 gap-2 p-2 round m-2">
          ...
          {/* Instagram */}
          <button className="btn btn-outline border-[#e5e5e5]">
            <svg
              aria-label="Google logo"
              width="16"
              height="16"
      ...
      <div className="mb-4">
        <h2 className="p-2 round m-2">Q-Zone</h2>
        <div className="grid grid-cols-1 gap-2 p-2 round m-2">
          {/* Email */}
